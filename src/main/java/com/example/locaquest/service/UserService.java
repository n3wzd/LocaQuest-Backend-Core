...
public class UserService {
    ...
    public String login(LoginRequest loginRequest) {
        ...
        return getLoginToken(user.getUserId(), user.getName());
    }
    
    public String getLoginToken(int userId, String name) {
        return tokenComponent.generateLoginToken(String.valueOf(userId), name);
    }
